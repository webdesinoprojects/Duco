...
const chargePlanRoutes = require("./Router/chargePlanRoutes.js"); // ✅ Added import
...
// ✅ Mount Charge Plan routes under correct path
//     Now your endpoint will be:
//     GET http://localhost:3000/api/chargeplan/getTotalsForQty
app.use("/api/chargeplan", chargePlanRoutes);
...
app.listen(port, () => {
  ...
  console.log(
    `🌐 ChargePlan endpoint available at: http://localhost:${port}/api/chargeplan/getTotalsForQty`
  );
});
